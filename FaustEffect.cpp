...
#define FAUSTVERSION "2.60.0"

// Version as separated [major,minor,patch] values
#define FAUSTMAJORVERSION 2
#define FAUSTMINORVERSION 60
...
class mydsp : public dsp {
 ...
 public:
	...
	virtual void instanceConstants(int sample_rate) {
		...
		float fConst3 = std::tan(40212.387f / fConst0);
		fConst4 = 2.0f * (1.0f - 1.0f / mydsp_faustpower2_f(fConst3));
		float fConst5 = 1.0f / fConst3;
		fConst6 = (fConst5 + -0.4f) / fConst3 + 1.0f;
		float fConst7 = (fConst5 + 0.4f) / fConst3 + 1.0f;
		fConst8 = 1.0f / fConst7;
		fConst9 = 1.0f / fConst0;
		fConst10 = 6.2831855f / fConst0;
		fConst11 = 2.0f / fConst0;
		fConst12 = 25.132742f / fConst0;
		fConst13 = 1.4285715f / fConst0;
		fConst14 = 18.849556f / fConst0;
		fConst15 = 1.1111112f / fConst0;
		fConst16 = 12.566371f / fConst0;
		fConst17 = 1.0f / (fConst3 * fConst7);
		fConst18 = 0.0f - fConst17;
		fConst19 = std::exp(0.0f - 2e+01f / fConst0);
		fConst20 = std::exp(0.0f - 5e+01f / fConst0);
		float fConst21 = std::tan(3141.5928f / fConst0);
		fConst22 = 2.0f * (1.0f - 1.0f / mydsp_faustpower2_f(fConst21));
		float fConst23 = 1.0f / fConst21;
		fConst24 = (fConst23 + -0.14285715f) / fConst21 + 1.0f;
		fConst25 = 1.0f / ((fConst23 + 0.14285715f) / fConst21 + 1.0f);
		fConst26 = std::exp(0.0f - 1e+02f / fConst0);
		float fConst27 = std::tan(20106.193f / fConst0);
		fConst28 = 2.0f * (1.0f - 1.0f / mydsp_faustpower2_f(fConst27));
		float fConst29 = 1.0f / fConst27;
		fConst30 = (fConst29 + -0.4f) / fConst27 + 1.0f;
		float fConst31 = (fConst29 + 0.4f) / fConst27 + 1.0f;
		fConst32 = 1.0f / fConst31;
		fConst33 = 1.0f / (fConst27 * fConst31);
		fConst34 = 0.0f - fConst33;
		float fConst35 = std::tan(10053.097f / fConst0);
		fConst36 = 2.0f * (1.0f - 1.0f / mydsp_faustpower2_f(fConst35));
		float fConst37 = 1.0f / fConst35;
		fConst38 = (fConst37 + -0.4f) / fConst35 + 1.0f;
		float fConst39 = (fConst37 + 0.4f) / fConst35 + 1.0f;
		fConst40 = 1.0f / fConst39;
		fConst41 = 1.0f / (fConst35 * fConst39);
		fConst42 = 0.0f - fConst41;
		float fConst43 = std::tan(5026.5483f / fConst0);
		fConst44 = 2.0f * (1.0f - 1.0f / mydsp_faustpower2_f(fConst43));
		float fConst45 = 1.0f / fConst43;
		fConst46 = (fConst45 + -0.4f) / fConst43 + 1.0f;
		float fConst47 = (fConst45 + 0.4f) / fConst43 + 1.0f;
		fConst48 = 1.0f / fConst47;
		fConst49 = 1.0f / (fConst43 * fConst47);
		fConst50 = 0.0f - fConst49;
		float fConst51 = std::tan(2513.2742f / fConst0);
		fConst52 = 2.0f * (1.0f - 1.0f / mydsp_faustpower2_f(fConst51));
		float fConst53 = 1.0f / fConst51;
		fConst54 = (fConst53 + -0.4f) / fConst51 + 1.0f;
		float fConst55 = (fConst53 + 0.4f) / fConst51 + 1.0f;
		fConst56 = 1.0f / fConst55;
		fConst57 = 1.0f / (fConst51 * fConst55);
		fConst58 = 0.0f - fConst57;
		float fConst59 = std::tan(1256.6371f / fConst0);
		fConst60 = 2.0f * (1.0f - 1.0f / mydsp_faustpower2_f(fConst59));
		float fConst61 = 1.0f / fConst59;
		fConst62 = (fConst61 + -0.4f) / fConst59 + 1.0f;
		float fConst63 = (fConst61 + 0.4f) / fConst59 + 1.0f;
		fConst64 = 1.0f / fConst63;
		fConst65 = 1.0f / (fConst59 * fConst63);
		fConst66 = 0.0f - fConst65;
		float fConst67 = std::tan(628.31854f / fConst0);
		fConst68 = 2.0f * (1.0f - 1.0f / mydsp_faustpower2_f(fConst67));
		float fConst69 = 1.0f / fConst67;
		fConst70 = (fConst69 + -0.4f) / fConst67 + 1.0f;
		float fConst71 = (fConst69 + 0.4f) / fConst67 + 1.0f;
		fConst72 = 1.0f / fConst71;
		fConst73 = 1.0f / (fConst67 * fConst71);
		fConst74 = 0.0f - fConst73;
		float fConst75 = std::tan(314.15927f / fConst0);
		fConst76 = 2.0f * (1.0f - 1.0f / mydsp_faustpower2_f(fConst75));
		float fConst77 = 1.0f / fConst75;
		fConst78 = (fConst77 + -0.4f) / fConst75 + 1.0f;
		float fConst79 = (fConst77 + 0.4f) / fConst75 + 1.0f;
		fConst80 = 1.0f / fConst79;
		fConst81 = 1.0f / (fConst75 * fConst79);
		fConst82 = 0.0f - fConst81;
		float fConst83 = std::tan(157.07964f / fConst0);
		fConst84 = 2.0f * (1.0f - 1.0f / mydsp_faustpower2_f(fConst83));
		float fConst85 = 1.0f / fConst83;
		fConst86 = (fConst85 + -0.4f) / fConst83 + 1.0f;
		float fConst87 = (fConst85 + 0.4f) / fConst83 + 1.0f;
		fConst88 = 1.0f / fConst87;
		fConst89 = 1.0f / (fConst83 * fConst87);
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addHorizontalSlider("damping", &fHslider1, FAUSTFLOAT(0.25f), FAUSTFLOAT(0.25f), FAUSTFLOAT(4e+01f), FAUSTFLOAT(0.01f));
		ui_interface->addHorizontalSlider("freq", &fHslider2, FAUSTFLOAT(3e+02f), FAUSTFLOAT(5e+01f), FAUSTFLOAT(1.3e+03f), FAUSTFLOAT(0.01f));
		ui_interface->addHorizontalSlider("stutter", &fHslider0, FAUSTFLOAT(2e+01f), FAUSTFLOAT(2e+01f), FAUSTFLOAT(5e+02f), FAUSTFLOAT(0.01f));
		ui_interface->closeBox();
	}
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		float fSlow2 = std::pow(0.001f, fConst9 / fSlow1);
		float fSlow3 = mydsp_faustpower2_f(fSlow2);
		float fSlow4 = float(fHslider2);
		float fSlow5 = (0.0f - 2.0f * fSlow2) * std::cos(fConst10 * fSlow4);
		float fSlow6 = std::pow(0.001f, fConst11 / fSlow1);
		float fSlow7 = mydsp_faustpower2_f(fSlow6);
		float fSlow8 = (0.0f - 2.0f * fSlow6) * std::cos(fConst12 * fSlow4);
		float fSlow9 = std::pow(0.001f, fConst13 / fSlow1);
		float fSlow10 = mydsp_faustpower2_f(fSlow9);
		float fSlow11 = (0.0f - 2.0f * fSlow9) * std::cos(fConst14 * fSlow4);
		float fSlow12 = std::pow(0.001f, fConst15 / fSlow1);
		float fSlow13 = mydsp_faustpower2_f(fSlow12);
		float fSlow14 = (0.0f - 2.0f * fSlow12) * std::cos(fConst16 * fSlow4);
		float fSlow15 = std::max<float>(1.1920929e-07f, std::fabs(fSlow4));
		float fSlow16 = fConst9 * fSlow15;
		float fSlow17 = 1.0f - fConst0 / fSlow15;
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			fRec1[0] = fSlow0 + fConst2 * fRec1[1];
			fRec0[0] = std::fmod(fRec1[0] + fRec0[1] + -1.9966141f, fRec1[0]);
			float fTemp0 = std::min<float>(0.002f * fRec0[0], 1.0f);
			float fTemp1 = float(input0[i0]);
			fVec0[0] = fTemp1;
			fRec5[0] = 0.995f * fRec5[1] + 0.1f * (fTemp1 - fVec0[1]);
			fRec4[0] = fRec5[0] - (fSlow5 * fRec4[1] + fSlow3 * fRec4[2]);
			fRec6[0] = fRec5[0] - (fSlow8 * fRec6[1] + fSlow7 * fRec6[2]);
			fRec7[0] = fRec5[0] - (fSlow11 * fRec7[1] + fSlow10 * fRec7[2]);
			fRec8[0] = fRec5[0] - (fSlow14 * fRec8[1] + fSlow13 * fRec8[2]);
			float fTemp2 = fRec4[0] + 0.9f * (fRec8[0] - fRec8[2]) + 0.7f * (fRec7[0] - fRec7[2]) + 0.5f * (fRec6[0] - fRec6[2]) - fRec4[2];
			float fTemp3 = 0.25f * fTemp2;
			fRec3[0] = fTemp3 - fConst8 * (fConst6 * fRec3[2] + fConst4 * fRec3[1]);
			float fTemp4 = std::fabs(fConst17 * fRec3[0] + fConst18 * fRec3[2]);
			float fTemp5 = ((fTemp4 > fRec2[1]) ? fConst20 : fConst19);
			fRec2[0] = fTemp4 * (1.0f - fTemp5) + fRec2[1] * fTemp5;
			float fTemp6 = fSlow16 + fRec11[1] + -1.0f;
			int iTemp7 = fTemp6 < 0.0f;
			float fTemp8 = fSlow16 + fRec11[1];
			fRec11[0] = ((iTemp7) ? fTemp8 : fTemp6);
			float fRec12 = ((iTemp7) ? fTemp8 : fSlow16 + fRec11[1] + fSlow17 * fTemp6);
			fRec13[0] = 1.0f - fConst26 * (1.0f - fRec13[1]);
			fRec10[0] = 0.5f * fRec13[0] * (2.0f * fRec12 + -1.0f) - fConst25 * (fConst24 * fRec10[2] + fConst22 * fRec10[1]);
			float fTemp9 = fConst25 * (fRec10[2] + fRec10[0] + 2.0f * fRec10[1]);
			fRec9[0] = fTemp9 - fConst8 * (fConst6 * fRec9[2] + fConst4 * fRec9[1]);
			fRec15[0] = fTemp3 - fConst32 * (fConst30 * fRec15[2] + fConst28 * fRec15[1]);
			float fTemp10 = std::fabs(fConst33 * fRec15[0] + fConst34 * fRec15[2]);
			float fTemp11 = ((fTemp10 > fRec14[1]) ? fConst20 : fConst19);
			fRec14[0] = fTemp10 * (1.0f - fTemp11) + fRec14[1] * fTemp11;
			fRec16[0] = fTemp9 - fConst32 * (fConst30 * fRec16[2] + fConst28 * fRec16[1]);
			fRec18[0] = fTemp3 - fConst40 * (fConst38 * fRec18[2] + fConst36 * fRec18[1]);
			float fTemp12 = std::fabs(fConst41 * fRec18[0] + fConst42 * fRec18[2]);
			float fTemp13 = ((fTemp12 > fRec17[1]) ? fConst20 : fConst19);
			fRec17[0] = fTemp12 * (1.0f - fTemp13) + fRec17[1] * fTemp13;
			fRec19[0] = fTemp9 - fConst40 * (fConst38 * fRec19[2] + fConst36 * fRec19[1]);
			fRec21[0] = fTemp3 - fConst48 * (fConst46 * fRec21[2] + fConst44 * fRec21[1]);
			float fTemp14 = std::fabs(fConst49 * fRec21[0] + fConst50 * fRec21[2]);
			float fTemp15 = ((fTemp14 > fRec20[1]) ? fConst20 : fConst19);
			fRec20[0] = fTemp14 * (1.0f - fTemp15) + fRec20[1] * fTemp15;
			fRec22[0] = fTemp9 - fConst48 * (fConst46 * fRec22[2] + fConst44 * fRec22[1]);
			fRec24[0] = fTemp3 - fConst56 * (fConst54 * fRec24[2] + fConst52 * fRec24[1]);
			float fTemp16 = std::fabs(fConst57 * fRec24[0] + fConst58 * fRec24[2]);
			float fTemp17 = ((fTemp16 > fRec23[1]) ? fConst20 : fConst19);
			fRec23[0] = fTemp16 * (1.0f - fTemp17) + fRec23[1] * fTemp17;
			fRec25[0] = fTemp9 - fConst56 * (fConst54 * fRec25[2] + fConst52 * fRec25[1]);
			fRec27[0] = fTemp3 - fConst64 * (fConst62 * fRec27[2] + fConst60 * fRec27[1]);
			float fTemp18 = std::fabs(fConst65 * fRec27[0] + fConst66 * fRec27[2]);
			float fTemp19 = ((fTemp18 > fRec26[1]) ? fConst20 : fConst19);
			fRec26[0] = fTemp18 * (1.0f - fTemp19) + fRec26[1] * fTemp19;
			fRec28[0] = fTemp9 - fConst64 * (fConst62 * fRec28[2] + fConst60 * fRec28[1]);
			fRec30[0] = fTemp3 - fConst72 * (fConst70 * fRec30[2] + fConst68 * fRec30[1]);
			float fTemp20 = std::fabs(fConst73 * fRec30[0] + fConst74 * fRec30[2]);
			float fTemp21 = ((fTemp20 > fRec29[1]) ? fConst20 : fConst19);
			fRec29[0] = fTemp20 * (1.0f - fTemp21) + fRec29[1] * fTemp21;
			fRec31[0] = fTemp9 - fConst72 * (fConst70 * fRec31[2] + fConst68 * fRec31[1]);
			fRec33[0] = fTemp3 - fConst80 * (fConst78 * fRec33[2] + fConst76 * fRec33[1]);
			float fTemp22 = std::fabs(fConst81 * fRec33[0] + fConst82 * fRec33[2]);
			float fTemp23 = ((fTemp22 > fRec32[1]) ? fConst20 : fConst19);
			fRec32[0] = fTemp22 * (1.0f - fTemp23) + fRec32[1] * fTemp23;
			fRec34[0] = fTemp9 - fConst80 * (fConst78 * fRec34[2] + fConst76 * fRec34[1]);
			fRec36[0] = fTemp3 - fConst88 * (fConst86 * fRec36[2] + fConst84 * fRec36[1]);
			float fTemp24 = std::fabs(fConst89 * fRec36[0] + fConst90 * fRec36[2]);
			float fTemp25 = ((fTemp24 > fRec35[1]) ? fConst20 : fConst19);
			fRec35[0] = fTemp24 * (1.0f - fTemp25) + fRec35[1] * fTemp25;
			fRec37[0] = fTemp9 - fConst88 * (fConst86 * fRec37[2] + fConst84 * fRec37[1]);
			float fTemp26 = fRec9[2] * (0.0f - fConst17 * fRec2[0]) + fRec16[2] * (0.0f - fConst33 * fRec14[0]) + fRec19[2] * (0.0f - fConst41 * fRec17[0]) + fRec22[2] * (0.0f - fConst49 * fRec20[0]) + fRec25[2] * (0.0f - fConst57 * fRec23[0]) + fRec28[2] * (0.0f - fConst65 * fRec26[0]) + fRec31[2] * (0.0f - fConst73 * fRec29[0]) + fRec34[2] * (0.0f - fConst81 * fRec32[0]) + fConst89 * fRec37[0] * fRec35[0] + fRec37[2] * (0.0f - fConst89 * fRec35[0]) + fConst81 * fRec34[0] * fRec32[0] + fConst73 * fRec31[0] * fRec29[0] + fConst65 * fRec28[0] * fRec26[0] + fConst57 * fRec25[0] * fRec23[0] + fConst49 * fRec22[0] * fRec20[0] + fConst41 * fRec19[0] * fRec17[0] + fConst33 * fRec16[0] * fRec14[0] + fConst17 * fRec9[0] * fRec2[0];
			fVec1[IOTA0 & 255] = fTemp26;
			float fTemp27 = fRec1[0] + fRec0[0];
			int iTemp28 = int(fTemp27);
			float fTemp29 = std::floor(fTemp27);
			int iTemp30 = int(fRec0[0]);
			float fTemp31 = std::floor(fRec0[0]);
			float fTemp32 = 0.0225f * fTemp2 * ((fVec1[(IOTA0 - std::min<int>(161, std::max<int>(0, iTemp30))) & 255] * (fTemp31 + (1.0f - fRec0[0])) + (fRec0[0] - fTemp31) * fVec1[(IOTA0 - std::min<int>(161, std::max<int>(0, iTemp30 + 1))) & 255]) * fTemp0 + (fVec1[(IOTA0 - std::min<int>(161, std::max<int>(0, iTemp28))) & 255] * (fTemp29 + (1.0f - fTemp27)) + (fTemp27 - fTemp29) * fVec1[(IOTA0 - std::min<int>(161, std::max<int>(0, iTemp28 + 1))) & 255]) * (1.0f - fTemp0));
			output0[i0] = FAUSTFLOAT(fTemp32);
			output1[i0] = FAUSTFLOAT(fTemp32);
			fRec1[1] = fRec1[0];
			fRec0[1] = fRec0[0];
			fVec0[1] = fVec0[0];
			fRec5[1] = fRec5[0];
	...
	#define FAUST_FILE_NAME "FaustEffect.dsp"
	...
	FAUST_ADDHORIZONTALSLIDER("damping", fHslider1, 0.25f, 0.25f, 4e+01f, 0.01f);
	FAUST_ADDHORIZONTALSLIDER("freq", fHslider2, 3e+02f, 5e+01f, 1.3e+03f, 0.01f);
	FAUST_ADDHORIZONTALSLIDER("stutter", fHslider0, 2e+01f, 2e+01f, 5e+02f, 0.01f);

	#define FAUST_LIST_ACTIVES(p) \
		p(HORIZONTALSLIDER, damping, "damping", fHslider1, 0.25f, 0.25f, 4e+01f, 0.01f) \
		p(HORIZONTALSLIDER, freq, "freq", fHslider2, 3e+02f, 5e+01f, 1.3e+03f, 0.01f) \
		p(HORIZONTALSLIDER, stutter, "stutter", fHslider0, 2e+01f, 2e+01f, 5e+02f, 0.01f) \
...
FaustEffect::FaustEffect() : AudioStream(FAUST_INPUTS, new audio_block_t*[FAUST_INPUTS])
{
#ifdef NVOICES
    int nvoices = NVOICES;
...
void FaustEffect::updateImp(void)
{
#if MIDICTRL
...
void FaustEffect::update(void) { updateImp<FAUST_INPUTS, FAUST_OUTPUTS>(); }

void FaustEffect::setParamValue(const std::string& path, float value)
{
    fUI->setParamValue(path, value);
}

float FaustEffect::getParamValue(const std::string& path)
{
